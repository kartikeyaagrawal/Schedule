...
class Data:
    print("Hello")
    ROOMS = [["LT1",200],["LT2",200],["LT3",100]]
    MEETING_TIMES = [["Slot1","MWF 09:00 - 10:00"], 
                      ["Slot2","MWF 10:00 - 11:00"],
                      ["Slot3","TTH 09:00 - 10:30"],
                      ["Slot4","TTH 10:30 - 12:00"]]
    INSTRUCTORS = [
        ["I1","Dr Nikhil Sharma"],
        ["I2","Mr Mukesh Jadon"],
        ["I3","Dr Rajeev Saxena"],
        ["I4","Dr Jay Prakash kar"] ]
    ...
    def __init__(self):
        ...
        course1 = Course("C1","BE",[self._instructors[0],self._instructors[1]],25)
        course2 = Course("C2","CLP",[self._instructors[0],self._instructors[1],self._instructors[2]],35)
        course3 = Course("C3","SNS",[self._instructors[0],self._instructors[1]],25)
        course4 = Course("C4","CP",[self._instructors[2],self._instructors[3]],30)
        course5 = Course("C5","OTA",[self._instructors[3]],35)
        course6 = Course("C6","DSA",[self._instructors[0],self._instructors[2]],45)
        course7 = Course("C7","AI",[self._instructors[1],self._instructors[3]],45)
        self._course = [course1,course2,course3,course4,course6,course7]
        dept1 = Department("Electroincs",[course1,course3])
        dept2 = Department("Computer Science",[course2,course4,course5])
        dept3 = Department("Physics",[course6,course7])
...
class GeneticAlgorithm:
    ...
    def _mutate_schedule(self, mutateSchedule):
        ...
        for i in range(0, len(mutateSchedule.get_classes())): 
            if(MUTATION_RATE > rnd.random()): mutateSchedule.get_classes()[i] = schedule.get_classes()[1] 
...
class DisplayMgr:
    ...
    def print_meeting_times(self):
        availableMeetingTimeTable = PrettyTable(['id','MeetingTime'])
    ...
    def print_generation(self,population):
        ...
        for i in range(0, len(schedules)):
            table1.add_row([str(i), round(schedules[i].get_fitness(),3), schedules[i].get_numbOfConflicts(),schedules[i].get_classes().__str__])
        print(table1)

    def print_schedule_as_table(self,schedule):
        classes = schedule.get_classes()
        table = PrettyTable(['class #','Dept','Course(number, max # of students)','Room(Capacity)','Instructor','timing'])
        for i in range(0, len(classes)):
